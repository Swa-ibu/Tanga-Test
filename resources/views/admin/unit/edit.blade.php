                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-7 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Financial Analysis" name="name" required value="{{ $unit->name }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select select2-multiple" name="courses[]" multiple>
                                        ...
                                        @foreach ($courses as $course)
																<option
																	@foreach($unit->courses as $unitCourse)
																		{{ $unitCourse->id == $course->id ? 'selected': '' }}
																	@endforeach
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-12 my-3">
                                ...
                                <textarea class="form-control" name="summary" placeholder="Unit Objectives" rows="4" maxlength="250">{{ $unit->short_desc }}</textarea>
                            </div>
                        </div>
