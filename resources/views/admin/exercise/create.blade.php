                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-5 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Financial Analysis Exercise" name="name" required>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select select2-multiple" name="lessons[]" multiple>
                                        ...
                                        @foreach ($lessons as $lesson)
                                            <option value="{{ $lesson->id }}">{{ $lesson->title }} @ {{ $lesson->topics->units->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-12 my-3">
                                ...
                                <textarea class="form-control" name="content" placeholder="Exercise" id="desc" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="row text-end">
                            <div class="col-lg-12">
                            <a href="{{ route('admin.exercise') }}" class="btn btn-cancel">Cancel</a>
