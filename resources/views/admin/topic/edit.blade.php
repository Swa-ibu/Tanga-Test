      ...
      <div class="page-btn me-lg-5">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('admin.topic.show', $topic->id) }}">View</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row my-4">
                            ...
                            <div class="col-lg-5 col-sm-12 col-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Introduction to Financial Analysis" name="name" required value="{{ $topic->name }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-5 col-sm-6 col-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-select select2-single" name="unit_id">
                                        <option value="{{ $topic->unit_id }}" selected>{{ $topic->units->name }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="objectives" id="desc" class="form-control"  rows="10">{!! $topic->desc !!}</textarea>
                        </div>
                        <div class="row">
